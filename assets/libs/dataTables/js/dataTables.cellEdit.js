        ...
        updateEditableCell: function (callingElement) {
            ...
            function _addValidationCss() {
                ...
                if (settings.allowNulls.errorClass) {
                    ...
                    $(inputField).css({ "border": "#da542e solid 1px" });
                }
            }
...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    switch (inputType) {
        case "list":
            input.html = startWrapperHtml + "<select class='" + inputCss + "' onblur='$(this).updateEditableCell(this)'>";
        ...
        case "datepicker-confirm":
	        input.html = startWrapperHtml + "<input id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "' value='" + oldValue + "'></input>" + endWrapperHtml;
        ...
        case "textarea-confirm":
            ...
            break;
        default: // text input
            input.html = startWrapperHtml + "<input id='ejbeatycelledit' type='text' class='" + inputCss + "' onblur='$(this).updateEditableCell(this)' value='" + oldValue + "'></input>" + endWrapperHtml;
            break;
    }
    return input;
}
