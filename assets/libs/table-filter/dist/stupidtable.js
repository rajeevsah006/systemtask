...
(function($) {
  ...
  $.fn.stupidtable_build = function(){
    return this.each(function() {
      ...
      trs.each(function(index,tr) {
        ...
        $(tr).children('td:visible').each(function(idx, td){
  ...
  var get_th = function($table, identifier){
      ...
      var $table_ths = $table.find('th:visible');
  ...
  var calculateTHIndex = function(sort_info){
    ...
    sort_info.$th.parents("tr").find("th").slice(0, base_index).filter(':visible').each(function() {
