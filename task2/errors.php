...
<head>
	...
	<link href="/systemtask/task2/assets/css/style.css" rel="stylesheet">
	...
	<div class="main-wrapper">
		<div class="error-box">
			<div class="error-body text-center">
				...
				<a href="/systemtask/task2/index" class="btn btn-lg btn-danger btn-rounded waves-effect waves-light" style="width: 300px;">Back to home</a>
			</div>
		</div>
	</div>
	<!------------------------------- error end ------------------------------------------->

	<script src="/systemtask/task2/assets/libs/jquery/dist/jquery.min.js"></script>
	<script src="/systemtask/task2/assets/libs/popper.js/dist/umd/popper.min.js"></script>
	<script src="/systemtask/task2/libs/bootstrap/dist/js/bootstrap.min.js"></script>
	<script>
